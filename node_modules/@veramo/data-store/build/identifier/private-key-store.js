...
class PrivateKeyStore extends key_manager_1.AbstractPrivateKeyStore {
    ...
    get({ alias }) {
        return __awaiter(this, void 0, void 0, function* () {
            const key = yield (yield (0, utils_1.getConnectedDb)(this.dbConnection)).getRepository(private_key_1.PrivateKey).findOneBy({ alias });
            if (!key)
    ...
    import(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingKey = yield keyRepo.findOneBy({ alias: key.alias });
