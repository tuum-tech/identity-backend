...
class CredentialIssuerLD {
    constructor(options) {
        ...
        this.ldCredentialModule = new ld_credential_module_1.LdCredentialModule({
            ...
            ldSuiteLoader: new ld_suite_loader_1.LdSuiteLoader({ veramoLdSignatures: options.suites }),
        });
        this.methods = {
    ...
    createVerifiablePresentationLD(args, context) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return yield this.ldCredentialModule.signLDVerifiablePresentation(presentation, identifier.did, signingKey, verificationMethodId, args.challenge || '', args.domain || '', Object.assign(Object.assign({}, args), { now }), context);
            }
            catch (error) {
                debug(error);
    ...
    createVerifiableCredentialLD(args, context) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const credential = Object.assign(Object.assign({}, args === null || args === void 0 ? void 0 : args.credential), { '@context': credentialContext, type: credentialType });
            ...
            try {
                ...
                return yield this.ldCredentialModule.issueLDVerifiableCredential(credential, identifier.did, signingKey, verificationMethodId, Object.assign(Object.assign({}, args.options), { now }), context);
            }
            catch (error) {
                debug(error);
                return Promise.reject(error);
    ...
    verifyCredentialLD(args, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.ldCredentialModule.verifyCredential(credential, args.fetchRemoteContexts || false, Object.assign(Object.assign({}, args.options), { now }), context);
        });
    }
    ...
    verifyPresentationLD(args, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.ldCredentialModule.verifyPresentation(presentation, args.challenge, args.domain, args.fetchRemoteContexts || false, Object.assign(Object.assign({}, args.options), { now }), context);
        });
    }
