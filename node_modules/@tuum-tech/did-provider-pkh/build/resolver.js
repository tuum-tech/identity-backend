...
function toDidDoc(did, accountId) {
    const { namespace } = caip_1.AccountId.parse(accountId).chainId;
    ...
    if (SECPK1_NAMESPACES.includes(namespace)) {
        ...
        doc['@context'][1].TezosMethod2021 = 'https://w3id.org/security#TezosMethod2021';
...
function getResolver() {
    return {
        pkh: (did, parsed, r, options) => __awaiter(this, void 0, void 0, function* () {
