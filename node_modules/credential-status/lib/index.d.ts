 ...
 *   [https://github.com/uport-project/credential-status]
 */
export declare type CredentialJwtOrJSON = string | {
 ...
 *   [https://github.com/uport-project/credential-status]
 */
export declare type StatusMethod = (credential: CredentialJwtOrJSON, didDoc: DIDDocument) => Promise<CredentialStatus>;
/**
...
export declare class Status implements StatusResolver {
    ...
    checkStatus(credential: CredentialJwtOrJSON, didDoc: DIDDocument): Promise<CredentialStatus>;
}
