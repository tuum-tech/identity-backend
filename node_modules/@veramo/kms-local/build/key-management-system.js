...
const debug = (0, debug_1.default)('veramo:kms:local');
/**
...
class KeyManagementSystem extends key_manager_1.AbstractKeyManagementSystem {
    ...
    sign({ keyRef, algorithm, data, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (managedKey.type === 'Ed25519' &&
                ...
                return yield this.signES256(managedKey.privateKeyHex, data);
            }
    ...
    eth_rawSign(managedKey, data) {
        return new signing_key_1.SigningKey("0x" + managedKey).signDigest(data).compact;
    }
    /**
    ...
    signEdDSA(key, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const signer = (0, did_jwt_1.EdDSASigner)((0, bytes_1.arrayify)(key, { allowMissingPrefix: true }));
    ...
    signES256K(privateKeyHex, alg, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const signer = (0, did_jwt_1.ES256KSigner)((0, bytes_1.arrayify)(privateKeyHex, { allowMissingPrefix: true }), alg === 'ES256K-R');
            const signature = yield signer(data);
            // base64url encoded string
            return signature;
        });
     ...
     */
    signES256(privateKeyHex, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const signer = (0, did_jwt_1.ES256Signer)((0, bytes_1.arrayify)(privateKeyHex, { allowMissingPrefix: true }));
            const signature = yield signer(data);
            // base64url encoded string
            return signature;
        });
