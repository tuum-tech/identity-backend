...
const debug = (0, debug_1.default)('veramo:w3c:message-handler');
/**
    ...
    handle(message, context) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (message.type === exports.MessageTypes.vc && message.data) {
                ...
                const result = yield context.agent.verifyCredential({ credential });
                if (result.verified) {
                    ...
                    throw new Error((_b = result.error) === null || _b === void 0 ? void 0 : _b.message);
                }
            }
            if (message.type === exports.MessageTypes.vp && message.data) {
                ...
                if (result.verified) {
                    ...
                    throw new Error((_c = result.error) === null || _c === void 0 ? void 0 : _c.message);
                }
            }
